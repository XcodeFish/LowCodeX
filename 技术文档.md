...
![模块架构图](./assets/images/lowcodex-module-architecture.png)
...
![租户隔离模式](./assets/images/tenant-isolation-modes.png)
...
![组件层次结构](./assets/images/component-hierarchy.png)
...
![组件通信模式](./assets/images/component-communication.png)
...
![表单设计器架构](./assets/images/form-designer-architecture.png)

#### 4.2.2 工作流设计器

工作流设计器采用可视化图形编辑方式，支持节点拖拽、连线和条件配置。

![工作流设计器架构](./assets/images/workflow-designer-architecture.png)
...
![横向扩展架构](./assets/images/horizontal-scaling.png)
...
![部署架构图](./assets/images/deployment-architecture.png)
